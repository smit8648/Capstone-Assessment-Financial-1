...
print(census2018.info())
print(census2018.head())
#finally split this into the information we need
census2018Keep = census2018[['Name','Total Spending','Total Income']]
census2018Keep = census2018Keep.iloc[[0]]
year = [2018]
census2018Keep['Year'] = year
#census2018Keep = census2018Keep[['Total Spending','Total Income']]
print(census2018Keep)
...
#finally split this into the information we need
census2017Keep = census2017[['Name','Total Spending','Total Income']]
census2017Keep = census2017Keep.iloc[[0]]
#census2017Keep = census2017Keep[['Total Spending','Total Income']]
year = [2017]
census2017Keep['Year'] = year
print(census2017Keep)
...
#finally split this into the information we need
census2016Keep = census2016[['Name','Total Spending','Total Income']]
census2016Keep = census2016Keep.iloc[[0]]
year = [2016]
census2016Keep['Year'] = year
#census2016Keep = census2016Keep[['Total Spending','Total Income']]
print(census2016Keep)
...
#finally split this into the information we need
census2015Keep = census2015[['Name','Total Spending','Total Income']]
census2015Keep = census2015Keep.iloc[[0]]
year = [2015]
census2015Keep['Year'] = year
#census2015Keep = census2015Keep[['Total Spending','Total Income']]
print(census2015Keep)
...
#finally split this into the information we need
census2014Keep = census2014[['Name','Total Spending','Total Income']]
census2014Keep = census2014Keep.iloc[[0]]
year = [2014]
census2014Keep['Year'] = year
#census2014Keep = census2014Keep[['Total Spending','Total Income']]
print(census2014Keep)
...
#finally split this into the information we need
census2013Keep = census2013[['Name','Total Spending','Total Income']]
census2013Keep = census2013Keep.iloc[[0]]
year = [2013]
census2013Keep['Year'] = year
#census2013Keep = census2013Keep[['Total Spending','Total Income']]
print(census2013Keep)
...
#finally split this into the information we need
census2012Keep = census2012[['Name','Total Spending','Total Income']]
census2012Keep = census2012Keep.iloc[[0]]
year = [2012]
census2012Keep['Year'] = year
#census2012Keep = census2012Keep[['Total Spending','Total Income']]
print(census2012Keep)
...
#finally split this into the information we need
census2011Keep = census2011[['Name','Total Spending','Total Income']]
census2011Keep = census2011Keep.iloc[[0]]
year = [2011]
census2011Keep['Year'] = year
#census2011Keep = census2011Keep[['Total Spending','Total Income']]
print(census2011Keep)
...
#finally split this into the information we need
census2010Keep = census2010[['Name','Total Spending','Total Income']]
census2010Keep = census2010Keep.iloc[[0]]
year = [2010]
census2010Keep['Year'] = year
#census2010Keep = census2010Keep[['Total Spending','Total Income']]
print(census2010Keep)
...
#finally split this into the information we need
census2009Keep = census2009[['Name','Total Spending','Total Income']]
census2009Keep = census2009Keep.iloc[[0]]
year = [2009]
census2009Keep['Year'] = year
#census2009Keep = census2009Keep[['Total Spending','Total Income']]
print(census2009Keep)
...
#finally split this into the information we need
census2008Keep = census2008[['Name','Total Spending','Total Income']]
census2008Keep = census2008Keep.iloc[[0]]
year = [2008]
census2008Keep['Year'] = year
#census2008Keep = census2008Keep[['Total Spending','Total Income']]
print(census2008Keep)

#joins in the necessary tables
census = pd.concat([census2018Keep,census2017Keep,census2016Keep,census2015Keep,census2014Keep,census2013Keep,
census2012Keep,census2011Keep,census2010Keep,census2009Keep,census2008Keep])
print(census)

census.to_csv('NationalCensus')
